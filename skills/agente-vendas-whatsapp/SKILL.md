...
- `buscar_preco_ao_vivo(handle, area_m2)` busca `GET https://www.facilpersianas.com.br/products/<handle>.json` (API pública do Shopify, sem precisar de browser) e interpola entre as variantes reais (`"WWW-HHH"` = largura-altura em cm) mais próximas da área pedida.
